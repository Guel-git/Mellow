...
enum TextLiteral {
    ...
    enum ResultView {
        ...
        static let previousAngelText = "당신에게 딱! 맞는 수면요정은\n"
        ...
        static let bestFavoriteText = "이보다 더 좋아질 수 있다는 걸 보여줄게!"
        static let zombieFavoriteText = "달콤한 잠을 선물해줄게요! 자신있어요."
        static let babyFavoriteText = "아침이 있는 하루, 기대되지 않아?"
        static let nervousFavoriteText = "걱정마, 아침만을 기다리게 만들어줄게."
        ...
        static let shortRoutineBeforeArray = ["내일 입을 옷 꺼내두기", "물 떠놓기", "스마트폰 없이 잠들기"]
        static let shortRoutineAfterArray = ["기상하기", "물 마시기"]
        static let longRoutineBeforeArray = ["내일 입을 옷 꺼내두기", "물 떠놓기", "방에 모든 불 끄기", "스마트폰 없이 잠들기"]
